...
public class SuitRoomController {
    ...
    @FXML
    private Text textHabiatacionesSuit;
    ...
    @FXML
    private Text textHabitacionSuit;

    @FXML
    private DatePicker fechaSuit;

    @FXML
    private Text textCaracteristicas1Hb;

    @FXML
    private Text textCoste1Hb;
